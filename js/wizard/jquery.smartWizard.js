...
function SmartWizard(target, options) {
    ...
    this.buttons = {
        previous : $('<a>'+options.labelPrevious+'</a>').attr("href","#").addClass("btn btn-default btn-lg"),
        next : $('<a>'+options.labelNext+'</a>').attr("href","#").addClass("btn btn-default btn-lg")
    ...
    var _init = function($this) {
        var elmActionBar = $('<div></div>').addClass("actionBar text-center");
