        ...
        <body class="nav-md">
                    ...
                    <div id="contenedor" class="right_col" role="main">
                        <div class="row">
                            <div class="btn-group btn-breadcrumb">
                                ...
                                <a href="#" class="btn btn-primary disabled">Nuevo Docente</a>
                            </div>
                        </div>
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="x_panel">
                                    ...
                                    <div class="x_content">
                                        ...
                                        <form id="nuevo_docente" name="nuevo_docente" action="modulos/docente/acciones.php?accion=nuevo" method="POST" data-parsley-validate class="form-horizontal">
                        ...
                        <!-- Modal SUCCESS -->
                        <div class="modal fade" id="DocenteSuccessAddModal" data-backdrop="static" data-keyboard="false" role="dialog">
                            <div class="modal-dialog">
                                <!-- Modal content-->
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h4 class="modal-title">Docente creado</h4>
                                    </div>
                                    <div class="modal-body">
                                        <p>¡El docente ha sido satisfactoriamente creado!. </p>
                                    </div>
                                    <div class="modal-footer">
                                        <a type="button" class="btn btn-success" href="adddocente.php">Crear otro docente</a>
                                        <a type="button" class="btn btn-primary" href="docentes.php">Volver a lista de docente</a>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <script>
                                                        $(document).ready(function () {
                                                            ...
                                                            $('#nuevo_docente').submit(function (e) {
                                                                e.preventDefault();
