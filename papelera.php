...
if (isset($_SESSION['id'])):
    ...
    <html lang="es">
        ...
        <body class="nav-md">
                    ...
                    <div id="contenedor" class="right_col" role="main">
                        <div class="row">
                            <div class="btn-group btn-breadcrumb">
                                ...
                                <a href="" class="btn btn-primary disabled">Papelera de Reciclaje</a>
                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="x_panel">
                                    <div class="x_title">
                                        <h2>Lista de Fichas eliminadas</h2>
                                    ...
                                    <div class="x_content">
                                        <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                            ...
                                            <tbody>
                                                <?php
                                                $query = 'SELECT f.id ficha_id, f.created fecha, cur.nombre curso_nombre, cur.condicion cond_curso,  cur.modalidad_id modalidad, c.apellidos apellidos, c.nombres nombres, c.id cliente_id, c.condicion cond_cliente FROM ' . $tabla . ' f INNER JOIN cliente c ON f.cliente_id = c.id INNER JOIN cursos cur ON f.curso_id = cur.id  WHERE f.estado = "0" ORDER BY f.created DESC';
                                                ...
                                                foreach ($registros AS $row):
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><a href="#FichaRecuperarModal" data-toggle="modal" onclick="RecuperarFicha('<?php echo $row['ficha_id']; ?>')" title="Recuperar" class="btn btn-xs btn-primary"><i class="fa fa-undo"></i></a></td>
                                                    </tr>
                                                    <?php
                                                endforeach;
                                                ?>
                        ...
                        <!-- Recuperar Ficha Form  -->
                        <div class="modal fade" id="FichaRecuperarModal" data-backdrop="static" data-keyboard="false" role="dialog" aria-labelledby="modalFichaRecuperarLabel">
                        </div>
                        <!-- END Recuperar Ficha Form  -->
            ...
            <script type="text/javascript">
                function RecuperarFicha(id) {
                    $.post("modulos/ficha/ficha-modal-recuperar.php", {id: id}, function (data) {
                        $('#FichaRecuperarModal').html(data);
                    });
                }
            </script>
        </body>
