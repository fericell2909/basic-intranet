        ...
        <body class="nav-md">
                    ...
                    <div id="contenedor" class="right_col" role="main">
                        <div class="row">
                            <div class="btn-group btn-breadcrumb">
                                ...
                                <a href="" class="btn btn-primary disabled">Lista de Docentes</a>
                            ...
                            <div class="title_right">
                                <div class="pull-right ">
                                    <div class="input-group">
                                        <a href="adddocente.php" class="btn btn-success"><i class="fa fa-plus m-right-xs"></i> Nuevo Docente</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                            ...
                                            <tbody>
                                                ...
                                                foreach ($registros AS $row):
                                                    ?>
                                                    <tr>
                                                        <td class="text-center"><a href="docente.php?id=<?php echo $row['id']; ?>" title="Ver" >Ver</a></td>
                                                        ...
                                                        <td><a href="editdocente.php?id=<?php echo $row['id']; ?>" title="Editar" class="btn btn-xs btn-default"><i class="fa fa-pencil"></i></a></td>
                                                        <td><a href="#DocenteEliminarModal" data-toggle="modal" onclick="EliminarDocente('<?php echo $row['id']; ?>')" title="Eliminar" class="btn btn-xs btn-danger"><i class="fa fa-times"></i></a></td>
                                                    </tr>
                                                    <?php
                                                endforeach;
                                                ?>
                        ...
                        <div class="modal fade" id="DocenteEliminarModal" data-backdrop="static" data-keyboard="false" role="dialog" aria-labelledby="modalDocenteEliminarLabel">
                        </div>
            ...
            <script type="text/javascript">
                function EliminarDocente(id) {
                    $.post("modulos/docente/docente-modal-eliminar.php", {id: id}, function (data) {
                        $('#DocenteEliminarModal').html(data);
                    });
                }
            </script>
        </body>
