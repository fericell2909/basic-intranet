                    ...
                    <div id="contenedor" class="right_col" role="main">
                        <div class="row">
                            <div class="btn-group btn-breadcrumb">
                                ...
                                <a href="#" class="btn btn-primary disabled">Editar Cliente</a>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="x_panel">
                                    <div class="x_title">
                                        <h2>Editar Cliente <b> <?php echo $registro['id']; ?> </b></h2>
                                        <div class="clearfix"></div>
                                    </div>
                                    <div class="x_content">
                                        <form id="editar_cliente" name="editar_cliente" action="modulos/cliente/acciones.php?accion=editar" method="POST" data-parsley-validate class="form-horizontal form-label-left">
                                            <input type="hidden" id="cliente_id" name="cliente_id" value="<?php echo $registro['id']; ?>">
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-6 col-md-9 col-sm-9 col-xs-12">
                                                    <select id="cbx_condicion" name="cbx_condicion" class="form-control select-condicion" required>
                                                        <option></option>
                                                        <option value="auns" <?php
                                                        if ($registro['condicion'] == 'auns'): echo 'selected';
                                                        endif;
                                                        ?> >Alumno o Ex - Alumno UNS</option>
                                                        <option value="tuns"<?php
                                                        if ($registro['condicion'] == 'tuns'): echo 'selected';
                                                        endif;
                                                        ?>>Trabajador UNS</option>
                                                        <option value="pgen" <?php
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-6 col-md-9 col-sm-9 col-xs-12">
                                                    <input id="ocupacion" name="ocupacion" type="text" class="form-control" placeholder="Carrera u ocupación del cliente" value="<?php echo $registro['ocupacion']; ?>" required autocomplete="off">
                                                </div>
                                            </div>
                                            <br>
                                            <div class="form-group">
                                                            ...
                                                            $('#editar_cliente').submit(function (e) {
                                                                ...
                                                                $.ajax({
                                                                    ...
                                                                    beforeSend: function () {
                                                                        ...
                                                                        .done(function () {
                                                                            $(location).attr('href', 'cliente.php?id=' + $('#cliente_id').val());
                                                                        })
                                                                        .always(function () {
                                                                            waitingDialog.hide();
                                                                        });
